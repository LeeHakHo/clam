...
from clam.models.utils.TSSM_utils import Conv2DBlock, ConvTranspose2DBlock, Linear
import torch
...
from clam.models.utils.TSSM_utils import Conv2DBlock, ConvTranspose2DBlock, Linear, MLP, GRUCell, LayerNormGRUCell, LayerNormGRUCellV2
from clam.models.utils.TSSM_transformer import Transformer
...
class TransformerWorldModel(nn.Module):
  ...
  def world_model_loss(self, global_step, traj, prior_state, post_state, temp):
    ...
    return model_loss, logs, prior_state, post_state
